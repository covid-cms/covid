...
use Covid\Blog\Models\Article as ArticleModel;
...
class Article extends Repository
{
    ...
    public function query(array $options = [])
    {
        ...
        if (isset($options['status']) && $options['status'] != ArticleModel::STATUS_ALL) {
    ...
    protected function validateUpdateData(ArticleModel $article, $data)
    {
        $availableStatus = config('blog.article.status');
        $sluglyRegex = config('regex.slugly');
    ...
    public function create(array $data)
    {
        ...
        $article = ArticleModel::create(Arr::except($data, ['tags', 'categories']));
